...
#include "num_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const num_interfaces::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<num_interfaces::msg::Num *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_num_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<num_interfaces::msg::Num>()
{
  return &num_interfaces::msg::typesupport_fastrtps_cpp::_Num__handle;
}
