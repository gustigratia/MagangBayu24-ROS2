...
#include "num_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Num_type_support_symbol_names_t _Num_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, num_interfaces, msg, Num)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, num_interfaces, msg, Num)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_num_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, num_interfaces, msg, Num)() {
  return &::num_interfaces::msg::rosidl_typesupport_c::Num_message_type_support_handle;
}
