...
#include "num_interfaces/msg/detail/num__rosidl_typesupport_fastrtps_c.h"
...
#include "num_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Num__ros_msg_type = num_interfaces__msg__Num;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_num_interfaces
size_t get_serialized_size_num_interfaces__msg__Num(
  const void * untyped_ros_message,
...
static uint32_t _Num__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_num_interfaces__msg__Num(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_num_interfaces
size_t max_serialized_size_num_interfaces__msg__Num(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_num_interfaces__msg__Num(
    full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, num_interfaces, msg, Num)() {
