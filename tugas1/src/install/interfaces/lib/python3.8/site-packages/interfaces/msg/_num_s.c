...
bool interfaces__msg__num__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._num.Num", full_classname_dest, 23) == 0);
  }
  interfaces__msg__Num * ros_message = _ros_message;
  {  // num1
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * interfaces__msg__num__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of Num */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._num");
  ...
  interfaces__msg__Num * ros_message = (interfaces__msg__Num *)raw_ros_message;
  {  // num1
    PyObject * field = NULL;
