...
#include <stddef.h>
#include "num_interfaces/msg/detail/num__rosidl_typesupport_introspection_c.h"
#include "num_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  num_interfaces__msg__Num__init(message_memory);
}

void Num__rosidl_typesupport_introspection_c__Num_fini_function(void * message_memory)
{
  num_interfaces__msg__Num__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Num__rosidl_typesupport_introspection_c__Num_message_member_array[1] = {
  {
    ...
    offsetof(num_interfaces__msg__Num, num1),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Num__rosidl_typesupport_introspection_c__Num_message_members = {
  "num_interfaces__msg",  // message namespace
  "Num",  // message name
  1,  // number of fields
  sizeof(num_interfaces__msg__Num),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_num_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, num_interfaces, msg, Num)() {
