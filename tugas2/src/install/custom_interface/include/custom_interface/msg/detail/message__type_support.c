...
#include <stddef.h>
#include "custom_interface/msg/detail/message__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  custom_interface__msg__Message__init(message_memory);
}

void Message__rosidl_typesupport_introspection_c__Message_fini_function(void * message_memory)
{
  custom_interface__msg__Message__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Message__rosidl_typesupport_introspection_c__Message_message_member_array[2] = {
  {
    ...
    offsetof(custom_interface__msg__Message, data1),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interface__msg__Message, data2),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Message__rosidl_typesupport_introspection_c__Message_message_members = {
  ...
  2,  // number of fields
  sizeof(custom_interface__msg__Message),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interface, msg, Message)() {
